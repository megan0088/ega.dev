...
const socialLinks = [
  { icon: GitBranch, href: 'https://github.com/megan0088', label: 'GitHub' },
  { icon: Globe, href: 'https://linkedin.com/in/ega-nugraha', label: 'LinkedIn' },
  { icon: Mail, href: 'mailto:eganeue@gmail.com', label: 'Email' },
];

const techBadges = ['Next.js', 'Flutter', 'TypeScript', 'Supabase', 'SAP B1', 'Swift'];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 w-full">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-base text-dark-500 max-w-xl mb-8 leading-relaxed">
          ...
          >
            <div className="relative">
              ...
              {/* Avatar container */}
              <div className="relative w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden border-2 border-white/10">
                <Image
                  src="/avatar.jpg"
                  alt="Muhamad Ega Nugraha"
                  fill
                  className="object-cover"
                  priority
                  onError={(e) => {
                    // Fallback to GitHub avatar if local photo not found
                    (e.target as HTMLImageElement).src = 'https://github.com/megan0088.png';
                  }}
                />
              </div>

              {/* Floating badge — Apple Dev Academy */}
              <motion.div
