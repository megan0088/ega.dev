...
const typeConfig = {
  work: { icon: Briefcase, color: 'text-brand-400', bg: 'bg-brand-500/10', border: 'border-brand-500/30', label: 'Work' },
  education: { icon: GraduationCap, color: 'text-accent-emerald', bg: 'bg-emerald-500/10', border: 'border-emerald-500/30', label: 'Education' },
  competition: { icon: Trophy, color: 'text-accent-purple', bg: 'bg-purple-500/10', border: 'border-purple-500/30', label: 'Competition' },
};
...
export default function ExperienceSection({ experiences }: ExperienceSectionProps) {
  ...
  const groups = [
    { label: 'Work Experience', items: work },
    { label: 'Education', items: education },
    { label: 'Competition', items: competition },
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-dark-400 text-sm font-mono mb-6">
            <span className="text-brand-400">// </span>experience
          </div>
        ...
        {experiences.length === 0 ? (
          <div className="text-center py-20 text-dark-500">
            No experiences yet. Add some from the admin dashboard.
          </div>
        ) : (
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 pb-2">
                            <div className="p-5 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/8 hover:border-white/15 transition-all duration-300 group">
